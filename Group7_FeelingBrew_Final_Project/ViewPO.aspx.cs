    ...
    public partial class ViewPO : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try //This method displays the data from the database in the gridview.
            {
                ...
                string Sql_statement = "SELECT * FROM PurchaseOrder";
                conn.Open();
                ds = new DataSet();
                ...
                gridViewPO1.DataSource = ds;
                gridViewPO1.DataBind();
                conn.Close();
            }
            ...
            {
                conn = new SqlConnection(connectStr);
                string Sql_statement = "SELECT * FROM PurchaseOrderDetails";
                conn.Open();
                ds = new DataSet();
                adapt = new SqlDataAdapter();
                comm = new SqlCommand(Sql_statement, conn);
                ...
                gridViewPO0.DataSource = ds;
                gridViewPO0.DataBind();
                conn.Close();
            }
            catch (SqlException ex) //Error message
            {
