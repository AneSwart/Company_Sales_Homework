    ...
    <form id="form1" runat="server">
        ...
        <table style="width:100%;">
            ...
            <tr>
                ...
                <td style="font-family: consolas">Need help?&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" OnClientClick="target = '_blank';" Text="Help" Font-Names="Consolas" />
                &nbsp;&nbsp; </td>
                <td></td>
            </tr>
            <tr>
