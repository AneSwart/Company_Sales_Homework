        ...
        public void insertData() //Method activates when btnPlaceOrder is clicked.
        {
            if (txtQty.Text != "") 
            {
                try
                {
                    ...
                    //Email
                    string message = "New Purchase Order has been finalised for :\n" + "Ingredient: " + ddListIngr.Text + "\n" + "Quantity Ordered: " + txtQty.Text + "\n" + 
                        "Unit Price: R" + Session["IngrLatestCost"].ToString() + "\n" + "Total excl VAT: R" + lblTotalExclVAT.Text + "\n" + "VAT: R" + lblVAT.Text + "\n" +
                        "Total incl VAT: R" + lblInclVAT.Text + "\n" + "PODate: " + Session["date"].ToString();
